...
class ReviewTest(LiveServerTestCase):
    ...
    def test_user_can_review_a_tutor(self):
        ...
        comment_box = self.browser.find_element_by_id('id_comment')
        comment_box.send_keys('Frankin is the best tutor, I have ever seen in my life.')
        ...
        self.assertIn('Frankin is the best tutor, I have ever seen in my life.', page_text)
